  ...
  <teleport to="body">
    <transition name="modal">
      ...
      >
        ...
        >
          <!-- Modal Header -->
          <div class="p-6 pb-0 flex justify-between items-center border-b dark:border-gray-700">
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <span 
                        ...
                        :class="{
                          'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300': permission.role === 'admin',
                          'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300': permission.role === 'editor',
                          'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300': permission.role === 'viewer'
                        }"
                      >
                        {{ permission.role }}
                      </span>
          ...
          <!-- Add User Section -->
          <div class="p-6 pt-0 border-t dark:border-gray-700">
  ...
  setup(props, { emit }) {
    ...
    const removePermission = async (userId) => {
      try {
        ...
        permissions.value = permissions.value.filter((p) => p.user._id !== userId);
      } catch (error) {
